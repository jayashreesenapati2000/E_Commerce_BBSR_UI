...
export class ProductService {
  ...
  public getAllProducts() {
	return this.httpClient.get<Product[]>("http://localhost:9095/getAllProducts");
  }

    public deleteProduct(productId: number) {
	return this.httpClient.delete("http://localhost:9095/deleteProductDetails/"+productId);
  }

  
   public getProductDetailsById(productId: string) {
	return this.httpClient.get<Product>("http://localhost:9095/getProductDetailsById/"+productId);
  }
